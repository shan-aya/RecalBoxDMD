...
#      systems_cache.dat est de nouveau deduit des images de JEUX de systems/<sys>/ (sous-dossiers compris),
#      jamais de _defaults/ (images systeme toujours en .raw565 => la v52 mettait tous les systemes en p et le
#      firmware v229 ne lisait plus aucun raw565pack de jeu en navigation rapide). Images non converties
#      comptees comme ce qu'elles deviendront (.png fixe, .gif animee). Nouvelle fonction _game_image_kinds().
#      Code identique a celui de main ; seule la numerotation differe (v54 de dev = Mode 4 fichiers a plat).
#
